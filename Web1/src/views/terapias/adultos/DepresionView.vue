...
const DEFAULT_TITLE = 'Depresión y estado de ánimo'
...
async function loadDepresionData(): Promise<DepresionData> {
...
const { data, loading, error } = useHydratedAsync('depresion:page', loadDepresionData)
...
const relatedLinks = getRelatedAdultTherapies('depresion')

const breadcrumbItems = computed(() => [
  { name: 'Inicio', path: '/' },
  { name: 'Psicóloga para adultos', path: '/terapias/adultos' },
  { name: title.value, path: '/terapias/adultos/depresion' },
])
