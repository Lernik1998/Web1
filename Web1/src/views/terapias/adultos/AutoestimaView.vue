...
const DEFAULT_TITLE = 'Autoestima y desarrollo personal'
...
async function loadAutoestimaData(): Promise<AutoestimaData> {
...
const { data, loading, error } = useHydratedAsync('autoestima:page', loadAutoestimaData)
...
const relatedLinks = getRelatedAdultTherapies('autoestima')

const breadcrumbItems = computed(() => [
  { name: 'Inicio', path: '/' },
  { name: 'Psicóloga para adultos', path: '/terapias/adultos' },
  { name: title.value, path: '/terapias/adultos/autoestima' },
])
