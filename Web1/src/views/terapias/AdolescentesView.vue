...
const DEFAULT_TITLE = 'Psicóloga para adolescentes'

type AdolescentesData = {
  title: string
  content: ParsedTherapyContent | null
  yoast: YoastHeadJson | null
}

async function loadAdolescentesData(): Promise<AdolescentesData> {
...
const { data, loading, error } = useHydratedAsync('adolescentes:page', loadAdolescentesData)
...
const relatedLinks = [
  ...
  { label: 'Psicóloga para padres y familia', href: '/terapias/padres-familia' },
