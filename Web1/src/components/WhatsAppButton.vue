<template>
  <div v-if="!bannerVisible" class="kb-whatsapp-slot">
    ...
    >
      <svg viewBox="0 0 448 512" width="26" height="26" aria-hidden="true">
        <path
          fill="currentColor"
 ...
 * Va por encima del de cookies (más "bottom" = más arriba): es la acción
 * principal de contacto directo, así que debe verse primero.
 */
.kb-whatsapp-slot {
  position: fixed;
  left: 32px;
